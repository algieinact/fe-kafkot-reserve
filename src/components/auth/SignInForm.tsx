  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        navigate(isAdminMode ? "/dashboard/reservations" : "/");
      } else {
    ...
    <div className="flex flex-col flex-1">
      <div className="w-full max-w-md pt-10 mx-auto">
        ...
        >
          ...
          {isAdminMode ? "Back to Home" : "Back to dashboard"}
        </Link>
      </div>
        ...
        <div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              {error && (
                <div className="mb-4 p-3 rounded-lg bg-error-50 dark:bg-error-900/20">
              ...
              <div className="space-y-6">
                <div>
                  <Label>
                    {isAdminMode ? "Username" : "Email"} <span className="text-error-500">*</span>{" "}
                  </Label>
                  <Input
                    placeholder={isAdminMode ? "admin" : "info@gmail.com"}
