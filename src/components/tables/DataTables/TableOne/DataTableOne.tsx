...
export default function DataTableOne({
  ...
  return (
    <div className="overflow-hidden bg-white dark:bg-white/[0.03] rounded-xl">
      ...
      {title && (
        <div className="flex items-center gap-3 px-4 py-4 border border-b-0 border-gray-100 dark:border-white/[0.05] rounded-t-xl">
          <h3 className="font-semibold text-gray-800 dark:text-white">{title}</h3>
        </div>
      )}

      {/* Controls Section - Show entries (left) | Search + Action button (right) */}
